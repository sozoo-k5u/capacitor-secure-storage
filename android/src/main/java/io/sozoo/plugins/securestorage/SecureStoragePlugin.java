package io.sozoo.plugins.securestorage;
...
public class SecureStoragePlugin extends Plugin {
    ...
    private String PREFIX = "CAPACITOR_SECURE_STORAGE_";
    ...
    private String getPrefixParam(PluginCall call) {
        String prefix = call.getString("prefix");
